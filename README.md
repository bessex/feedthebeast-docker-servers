# Dockerized FTB Minecraft servers [![Build Status](https://travis-ci.com/bessex/feedthebeast-docker-servers.svg?branch=testing)](https://travis-ci.com/bessex/feedthebeast-docker-servers)
